...
import { makeBuyOrder, makeSellOrder } from "../store/interactionsWithChain";
    ...
    <Tabs defaultActiveKey="buy" className="bg-dark text-white">
      <Tab eventKey="buy" title="Buy" className="bg-dark">
        ...
        >
          <div className="form-group small">
            <label>Buy Amount (MGT)</label>
            <div className="input-group">
              <input
                type="text"
                className="form-control form-control-sm bg-dark text-white"
                placeholder="MGT Buy Amount"
                onChange={(e) =>
          ...
          <div className="form-group small">
            <label>Buy Price (MGT)</label>
            <div className="input-group">
              <input
                type="text"
                className="form-control form-control-sm bg-dark text-white"
                placeholder="MGT Buy Price"
      ...
      <Tab eventKey="sell" title="Sell" className="bg-dark">
        ...
        >
          ...
          <div className="form-group small">
            <label>Sell Price (MGT)</label>
            <div className="input-group">
              <input
                type="text"
                className="form-control form-control-sm bg-dark text-white"
                placeholder="MGT Sell Price"
                onChange={(e) =>
